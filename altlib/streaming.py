...
import re
import requests
#bmc from requests.exceptions import Timeout
from requests.exceptions import Timeout, ConnectionError #bmc
from requests.packages.urllib3.exceptions import ReadTimeoutError, ProtocolError #bmc
...
class Stream(object):
    ...
    def _run(self):
        ...
        while self.running:
            ...
            #bmc except (Timeout, ssl.SSLError) as exc:
            except (Timeout, ssl.SSLError, ConnectionError, ReadTimeoutError, ProtocolError) as exc: #bmc
